...
pred.grun <- SingleR(test=sce_object_all_genes, ref=breast, labels=breast$CAFtype, de.method="wilcox")
saveRDS(object = pred.grun, file = "../../04_results/singler/singler-default-params-labels-breast-ref-use-all-genes-norm-reference.Rds")
