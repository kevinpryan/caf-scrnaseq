...
# 3. Clean Reference
# Remove dCAF (dividing) hsp_tpCAF, tpCAF, apCAF, IDO_CAF
# However, filtering the GENES is usually sufficient. 
# Removing the reference labels is an extra safety step.
types_to_remove <- c("dCAF", "tpCAF", "hsp_tpCAF", "apCAF", "IDO_CAF")
...
saveRDS(object = pred, file = "../../04_results/singler/singler-remove-all-culture-artifacts-output-remove-apCAF.Rds")
saveRDS(object = sce_query, file = "../../04_results/singler/sce_object_for_singleR_remove-all-artifacts-remove-apCAF.Rds")
saveRDS(object = integrated_seurat, file = "../../04_results/singler/integrated_seurat_annotated_singleR-remove-all-artifacts-remove-apCAFs-20251202.Rds")
